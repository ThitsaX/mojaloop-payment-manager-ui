...
type FxpTechnicalDashboardProps = {
...
const FxpTechnicalDashboard: FC<FxpTechnicalDashboardProps> = ({
  partyLookupRateData,
  ...
  return (
    <div className="fxpdashboard">
      <Heading size="3">FXP Technical Dashboard</Heading>
...
export default loadTechnicalDashboard(connect(stateProps, dispatchProps)(FxpTechnicalDashboard));
