...
export const getTransfersNextCursor = (state: State) => state.transfers.transfersNextCursor;
export const getTransfersHasMore = (state: State) => state.transfers.transfersHasMore;
